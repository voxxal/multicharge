...
public class Player extends Entity {
    ...
    public void draw() {
        ...
        DrawRectanglePro(new Rectangle().x(pos.x-10).y(pos.y-radius + 4).width(40).height(8), new Vector2().x(-10).y(-radius + 4), angle, new Color().r((byte)140).b((byte)136).g((byte)126).a((byte)255));
    }
